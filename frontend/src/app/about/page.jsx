...
export default function AboutUs() {
  ...
  const founder = {
    ...
    description:
      "The visionary founder who established Eastern Petroleum in 1964 with a dream to provide superior quality lubricants. His principles of quality, integrity, and customer satisfaction continue to guide our company today.",
    legacy:
      "His unwavering commitment to excellence and innovation laid the foundation for what Eastern Petroleum is today - a trusted name in the lubricant industry for over six decades.",
  }
          ...
          <div className="mb-16">
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-3xl p-8 md:p-12 border border-orange-200">
              <div className="text-center mb-8">
                <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-orange-600 to-orange-700 rounded-full mb-6 shadow-lg">
                ...
                <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">{founder.name}</h3>
                ...
                <div className="text-orange-700 font-medium mb-6">{founder.years}</div>
              </div>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-200">
                      ...
                      <p className="text-gray-700 leading-relaxed">{founder.legacy}</p>
                    </div>
                  </div>

                  <div className="text-center lg:text-left">
                    <div className="bg-white rounded-2xl p-8 shadow-lg border border-orange-200">
                      <h4 className="text-xl font-bold text-gray-900 mb-6">Founding Principles</h4>
                      <div className="space-y-4">
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">Never compromise on product quality</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            <div className="font-semibold text-gray-900">Customer Dedication</div>
                            <div className="text-sm text-gray-600">Build lasting relationships</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">Continuous improvement and growth</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">Honest and ethical business practices</div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="mt-8 text-center">
                  <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-200 max-w-3xl mx-auto">
                    <svg className="w-8 h-8 text-orange-600 mx-auto mb-4" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h4v10h-10z" />
                    </svg>
                    <p className="text-lg italic text-gray-700 mb-4">
                      "Quality is not an act, it is a habit. Build your business on the foundation of trust, and success
                      will follow."
                    </p>
                    <div className="text-orange-600 font-semibold">- Madanlal Rathi, Founder</div>
                  </div>
                </div>
              </div>
            </div>
