                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                        ...
                        <div className="lg:col-span-1">
                            ...
                            <div className="flex space-x-4">
                                <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-orange-600 transition-colors duration-200">
                                ...
                                <div className="flex items-start gap-3 group">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-1">
                                            <a href="mailto:office@eastto.in" className="text-gray-300 text-sm hover:text-orange-400 transition-colors duration-200 block">
                                                office@eastto.in
                                            </a>
                                            <a href="mailto:sales@eastto.in" className="text-gray-300 text-sm hover:text-orange-400 transition-colors duration-200 block">
                                                sales@eastto.in
                                            </a>
                                        </div>
                                    </div>
